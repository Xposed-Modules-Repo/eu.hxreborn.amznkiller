<h1 align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/hxreborn/amznkiller/main/assets/banner_dark.png">
    <img src="https://raw.githubusercontent.com/hxreborn/amznkiller/main/assets/banner_light.png" alt="AmznKiller" width="520">
  </picture>
</h1>
...
Amazon disables Android force dark via `forceDarkAllowed=false` in its theme. The module triggers GPU-level darkening across native views and WebViews, plus supplementary CSS.
